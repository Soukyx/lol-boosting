...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="50" style="background-image: url(images/tft.webp);
  ...
  <div style="background-color:rgba(0, 0, 0, 0.7); border-bottom:solid 1px #ccc;
    ...
    <p id="podnadpis" class="mx-auto text-center">TFT Elo Boosting</p>
    <br>
