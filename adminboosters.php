							...
							<tr id="<?php echo $row["staff_id"]; ?>">
								...
								<td>
									<a href="#editEmployeeModal" class="edit" data-toggle="modal">
										...
										<i class="material-icons update" data-toggle="tooltip" data-id="<?php echo $row["staff_id"]; ?>" data-name="<?php echo $row["staff_name"]; ?>" data-email="<?php echo $row["descr"]; ?>" title="Edit">&#xE254;</i>
									</a>
									<a href="#deleteEmployeeModal" class="delete" data-id="<?php echo $row["staff_id"]; ?>" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
								</td>
							</tr>
							</form>
						<?php
