...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="50" style="background-image: url(images/lol.jpg);
        ...
        <form action="backend/orderdb.php" method="post" enctype="multipart/form-data">
          ...
          <div class="col-md-12 row" style="margin: auto;">
            <div class="col text-center col-md-2">
              ...
              <label for="ciron"><img class="rank-select-mini" src="https://www.gameboost.eu/assets/img/ranks/lol/mini/iron.png">
            ...
            <div class="col text-center col-md-2">
              ...
              <label for="cbronze"><img class="rank-select-mini" src="https://www.gameboost.eu/assets/img/ranks/lol/mini/bronze.png">
                <div class="tick_container">
                  <div class="tick"><i class="fa fa-check"></i></div>
                </div>
              </label>
            ...
            <div class="col text-center col-md-2">
              ...
              <label for="csilver"><img class="rank-select-mini" src="https://www.gameboost.eu/assets/img/ranks/lol/mini/silver.png">
                <div class="tick_container">
                  <div class="tick"><i class="fa fa-check"></i></div>
                </div>
              </label>
            ...
            <div class="col text-center col-md-2">
              ...
              <label for="cgold"><img class="rank-select-mini" src="https://www.gameboost.eu/assets/img/ranks/lol/mini/gold.png">
                <div class="tick_container">
                  <div class="tick"><i class="fa fa-check"></i></div>
                </div>
              </label>
            ...
            <div class="col text-center col-md-2">
              ...
              <label for="cplatinum"><img class="rank-select-mini" src="https://www.gameboost.eu/assets/img/ranks/lol/mini/platinum.png">
                <div class="tick_container">
                  <div class="tick"><i class="fa fa-check"></i></div>
                </div>
              </label>
          ...
          <div class="col-12" style="margin: auto;">
            ...
            <div class="form-group row">
              <div class="col-md-12">
                <script src="https://www.paypal.com/sdk/js?client-id=AfSn5KBMa2airN1Eyn-8WCwJQIX0fKt0mUeUN7Os1gmd-VPSZftT0dO2WTgZSrxIo82cWRXsS1mXGlh5&currency=USD&disable-funding=credit,card"><input type="submit"></input></script>              </div>
            </div>
            <script>
            ...
            <button><div type="submit" id="paypal-button-container" method="post" onclick="Send_Data()" action="backend/orderdb.php"> </div></button>
            <br>        
...
<script>
  ...
  function Send_Data(){
      var user_name=document.getElementById("user_name").value;
        var crank=document.querySelector('input[name=crank]:checked').value
        var division=document.querySelector("input[name=cdivision]:checked").value;
        var rank=document.querySelector("input[name=rank]:checked").value;
        var division=document.querySelector("input[name=division]:checked").value;
        var queueType=document.querySelector("input[name=queueType]:checked").value;
        var lolserver=document.querySelector("input[name=lolserver]:checked").value;
        var price=document.getElementById("result").value;

        var httpr=new XMLHttpRequest();
        httpr.open("POST","./backend/orderdb.php",true);
