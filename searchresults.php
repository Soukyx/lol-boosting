...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="50" style="background-image: url(gwen.jpg);
  ...
  <section>
    ...
    ?>
      ...
      <div class="container">
        <div id="card" class="card card-container col-md-6">
          <div class="text-center">
            ...
            ?>
                  ...
                  ?>
                  <br>
                  <li class="text-center col-md-12">
                    ...
                    <br>
                    <div class='info'>
                      <p class="inf">Name: <?php echo $user_data['user_name']; ?></p>
                    </div>
                    <div class='info'>
                      <p class="inf">Email: <?php echo $user_data['email']; ?></p>
                    </div>
                    <div class='info'>
                      <p class="inf">Usertype: <?php echo $user_data['usertype']; ?></p>
                    </div>
                    <hr>
                    <div class='info'>
                      <h3 class="inf">Orders:</h3>
                    </div>
                  </li>
          ...
          if (isset($_GET['search'])) {
            ...
            $query = "SELECT crank, cdivision, rank, division,  queueType, lolserver, price FROM orders WHERE user_name = '$s' OR user_name = '$s' ORDER BY id DESC LIMIT 5";
            ...
            ?>
                  ...
                  <li>
                    ...
                    <div class="col-md-12 row">
                      <p>crank: <?php echo $user_data['crank']; ?></p>
                    </div>
                    <div class="col-md-12 row">
                      <p>cdivision: <?php echo $user_data['cdivision']; ?></p>
                    </div>
                    <div class="col-md-12 row">
                      <p>rank: <?php echo $user_data['rank']; ?></p>
                    </div>
                    <div class="col-md-12 row">
                      <p>division: <?php echo $user_data['division']; ?></p>
                      <div class="col-md-12 row">
                      </div>
                      <p>queue type: <?php echo $user_data['queueType']; ?></p>
                      <div class="col-md-12 row">
                        <p>server: <?php echo $user_data['lolserver']; ?></p>
                      </div>
                      <div class="col-md-12 row ">
                        <p>price: <?php echo $user_data['price']; ?></p>
                      </div>
                    </div>
                    <hr>
                  </li>
